...
if(mbtiType == "INFJ") {
	System.out.print(""" The INFJ personality type, known as the Advocate, is a rare gem in the world of personalities.
...
if(mbtiType == "ISTJ") {
	System.out.print(""" Reliable and Responsible: ISTJs thrive in structured environments, meticulously following rules and procedures. 
...
if(mbtiType == "ISFJ") {
	System.out.print(""" ISFJs feel a deep sense of responsibility to those around them. They meet deadlines, remember birthdays, and uphold traditions. Their loyalty extends beyond family and friends—it often encompasses their communities and employers.
...
if(mbtiType == "ISFP") {
	System.out.print(""" ISFPs embody a free-spirited and artistic nature, dancing to their own rhythm:
...
if(mbtiType == "INTJ" ) {
	System.out.print(""" INTJs have an insatiable thirst for knowledge. They value creative ingenuity, straightforward rationality, and self-improvement. Their minds are never at rest, constantly analyzing everything around them.
...
if(mbtiType == "ISTP") {
	System.out.print(""" ISFPs are artists at heart. They express themselves through music, painting, or other creative outlets. Their sensitivity to aesthetics and emotions allows them to create beauty that resonates with others.""");
}
if(mbtiType == "INFP") {
	System.out.print(""" INFPs are dreamers and idealists. They seek harmony and authenticity, often channeling their emotions into poetry, storytelling, or advocating for causes close to their hearts. Their empathy makes them natural healers.
}	""");
if (mbtiType == "INTP") {
	System.out.print(""" INTPs are brilliant thinkers. They dissect complex problems, invent theories, and explore abstract concepts. Their minds are like intricate blueprints, constructing new ideas and challenging conventional wisdom.
	""");
}
if(mbtiType == "ESTP") {
	System.out.print(""" ESTPs are action-oriented thrill-seekers. They live for the adrenaline rush, whether it’s through sports, adventure, or daring feats. Their charisma and spontaneity make them magnetic to others.
	""");
}
if(mbtiType == "ESFP") {
	System.out.print(""" ESFPs light up any room they enter. They’re the life of the party, entertaining with their humor, dance moves, and infectious energy. Their zest for life inspires everyone around them.
	""");
}
if(mbtiType == "ENFP") { 
	System.out.print(""" ENFPs are enthusiastic visionaries. They champion causes, rally people together, and ignite change. Their creativity knows no bounds, and they thrive on connecting with others.
	""");
}
if(mbtiType == "ENTP") { 
	System.out.print("""  ENTPs are intellectual explorers. They question everything, challenge norms, and dive into debates. Their wit and curiosity lead them to innovative solutions and groundbreaking ideas.
	""");
}
if(mbtiType == "ESTJ") { 
	System.out.print("""  ESTJs are natural leaders. They organize, plan, and execute flawlessly. Their practicality and efficiency ensure that projects get done, teams stay on track, and goals are achieved.
	""");
}
if(mbtiType == "ESFJ") { 
	System.out.print(""" ESFJs are nurturing caretakers. They put others’ needs first, creating a warm and supportive environment. Their attention to detail and social skills make them excellent hosts and friends.
	""");
}
if(mbtiType == "ENFJ") { 
	System.out.print("""  ENFJs inspire and guide. They mentor, uplift, and bring out the best in people. Their charisma and intuition allow them to connect deeply with others, fostering growth and understanding.
	""");
}
if(mbtiType == "ENTJ") { 
